  ...
  return (
    <div className="space-y-8">
      <AnimatedSection>
        ...
        <p className="font-sans text-sm text-charcoal/50 mt-1">Every visit earns you points. Every point brings you closer to something great.</p>
      </AnimatedSection>
      ...
      <AnimatedSection delay={0.16}>
        <div className="bg-gradient-to-br from-white to-cream/40 rounded-2xl shadow-card p-6 lg:p-8">
          <h3 className="font-sans text-xs uppercase tracking-widest text-gray-400 mb-6">How far you&apos;ve come</h3>
      ...
      <AnimatedSection delay={0.24}>
        <div className="bg-gradient-to-br from-white to-cream/40 rounded-2xl shadow-card p-6 lg:p-8">
          <h3 className="font-sans text-xs uppercase tracking-widest text-gray-400 mb-6">What you get as a Gold Member</h3>
